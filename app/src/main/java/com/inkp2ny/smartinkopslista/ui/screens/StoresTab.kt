...
fun StoresTab() {
    Column(
        ...
        Text(text = "Butiker kommer snart", style = MaterialTheme.typography.titleMedium)
        Text(
            text = "Här kommer du kunna spara dina butiker och få påminnelser baserat på plats.",
